        ...
        <div className="flex min-h-screen">
            ...
            <div className="w-full md:w-1/3 min-h-screen border-r border-gray-200 flex flex-col">
               <WithLoggedInHeader />
                ...
                {/* Deposit Cash Card */}
                <div className="m-4 rounded-lg bg-[#3b7de1] p-5 text-white relative overflow-hidden" style={{background: "linear-gradient(135deg, #3b7de1 0%, #4a8ff7 100%)"}}>
                    <div className="flex justify-between items-center mb-4">
                        <div className="flex items-center space-x-2 font-bold text-lg">
                            <img alt="Green cash icon" className="w-5 h-4" height="15" src="https://storage.googleapis.com/a1aa/image/cc062ba3-deee-4092-928d-b21f563feaf6.jpg" width="20"/>
                            <span>₹10</span>
                        </div>
                        <button
                    ...
                    <img alt="Decorative blue circle overlay" className="absolute bottom-0 right-0 opacity-20 pointer-events-none select-none" height="120" src="https://storage.googleapis.com/a1aa/image/bcefda77-1645-4687-897b-d5344a830842.jpg" style={{borderRadius: "50%"}} width="120"/>
                </div>
                {/* Winnings Cash Card */}
                <div className="m-4 rounded-lg bg-[#7a9aff] p-5 text-white relative overflow-hidden" style={{background: "linear-gradient(135deg, #7a9aff 0%, #8aa7ff 100%)"}}>
                    <div className="flex justify-between items-center mb-4">
                        <div className="flex items-center space-x-2 font-bold text-lg">
                            <img alt="Green cash icon" className="w-5 h-4" height="15" src="https://storage.googleapis.com/a1aa/image/cc062ba3-deee-4092-928d-b21f563feaf6.jpg" width="20"/>
                            <span>₹0</span>
                    ...
                    <img alt="Decorative lighter blue circle overlay" className="absolute bottom-0 right-0 opacity-20 pointer-events-none select-none" height="120" src="https://storage.googleapis.com/a1aa/image/dbe91e48-4a6d-4291-296a-12cdaac4b3f4.jpg" style={{borderRadius: "50%"}} width="120"/>
                </div>
            </div>
            {/* Right Content */}
            <div className="flex-1 flex flex-col justify-center items-center bg-[#f9f9f9] relative overflow-hidden">
                ...
                <svg aria-hidden="true" className="absolute top-0 left-0 w-full h-full pointer-events-none select-none" preserveAspectRatio="none" viewBox="0 0 100 100">
                    <defs>
