      ...
      <LeftSideLayout>
        <div className="p-4 flex flex-col space-y-4">
          <section className="bg-gray-100 rounded-md p-4 border border-gray-200 mt-2">
            <div className="flex justify-center items-center space-x-6 mb-2 text-xs text-gray-600 font-semibold">
              <div className="flex flex-col items-center">
                <span>Han-Solo_215309</span>
                <img
                  alt="Avatar of Han-Solo_215309 with black hair and white game controller glasses with red buttons"
                  className="w-8 h-8 rounded-full"
                  height="32"
                  src="https://storage.googleapis.com/a1aa/image/d714707d-dbb0-4d88-ee2d-af53018ff613.jpg"
                  width="32"
                />
              </div>
              <div className="flex flex-col items-center">
              ...
              <div className="flex flex-col items-center">
                <span>Dormé_805104</span>
                <img
                  alt="Avatar of Dormé_805104 with brown hair and teal shirt"
                  className="w-8 h-8 rounded-full"
                  height="32"
                  src="https://storage.googleapis.com/a1aa/image/d444fd44-eaf4-4b18-b372-f8f84eb87c62.jpg"
                  width="32"
                />
              </div>
            </div>
          ...
          <section className="text-center text-[9px] font-bold text-gray-700 bg-gray-300 rounded-md p-2 m-2">
            ...
            <span className="underline">SAMPLE LUDO {""}</span>
          ...
          <section className="bg-gray-200 rounded-md p-6 mb-2">
            ...
            <div className="flex justify-center">
              <input
                className="text-center text-white-500 text-sm border border-gray-300 rounded-l-md px-3 py-2 w-32 focus:outline-none bg-black"
                type="text"
              />
            ...
            <div className="flex justify-center mt-3">
              <button
                className="bg-green-500 text-white text-xs font-semibold px-5 py-2 rounded hover:bg-green-600 transition"
                type="button"
              >
                SET ROOM CODE
              </button>
          ...
          <section className="border border-gray-300 rounded-md p-4 mb-2">
            ...
            <div className="text-[12px] text-white-700 border border-gray-300 rounded-md p-2 space-y-2">
              ...
              <p className="flex items-center space-x-1">
                <i className="fas fa-money-bill-wave text-green-600 text-xs"></i>
                <span>25 Penalty will be charged for not updating result.</span>
              </p>
            </div>
          </section>
          ...
          <section className="space-y-2">
            <button
              className="w-full bg-green-600 text-white text-[9px] font-bold rounded-full py-2 flex justify-center items-center space-x-2 hover:bg-green-700 transition"
              type="button"
            >
            ...
            <button
              className="w-full bg-red-600 text-white text-[9px] font-bold rounded-full py-2 hover:bg-red-700 transition"
              type="button"
            >
              I LOST THE GAME
            </button>
            <button
              className="w-full bg-gray-600 text-white text-[9px] font-bold rounded-full py-2 hover:bg-gray-700 transition"
              type="button"
            >
              CANCEL THE GAME
            </button>
