    ...
    return (
        <>
            <div className="flex items-center justify-between px-4 py-3 border-b border-gray-200 bg-white sticky top-0 z-20">
                ...
                <img alt="Sample logo with a stylized head wearing gaming glasses and a mask" className="h-10 w-10" height="40" src="https://storage.googleapis.com/a1aa/image/f452dcb6-0e8a-4372-253f-928ec73d8237.jpg" width="40" />
                <button
                ...
                >
                    ...
                    <span aria-label="Add cash" className="text-gray-400 hover:text-gray-600 text-lg font-bold">
                        +
                    </span>
                </button>
            </div>
            ...
            >
                ...
                >
                    ...
                    <div className="p-4">
                        <Link href="/battles" className="mb-2 font-semibold text-gray-700 block" onClick={() => setSidebarOpen(false)}>Home</Link>
